                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('subcategory.update', $subCategory->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="subC_en" id="subC_en" value="{{old('subC_en',$subCategory->subC_en)}}"  placeholder="Danh mục con English">
                            @error('subC_en')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="subV_vie" id="subV_vie" value="{{old('subV_vie',$subCategory->subV_vie)}}"  placeholder="Danh mục con Vietnamese">
                            @error('subV_vie')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <select id="categorie_id" class="form-control" name="categorie_id">
                                ...
                                @foreach($category as $categories)
                                    ...
                                    <option value="{{$categories->id}}" id="categorie_id" @if(old('categorie_id',$subCategory->categorie_id)==$categories->id) selected="selected" @endif>{{$categories->nameC_en}} | {{$categories->nameV_vie}}</option>
                                    @endif
                                @endforeach
                            </select>
                        ...
                        <div class="form-check">
                            ...
                            <input style="width: 18px; height: 18px" class="form-check-input " name="status" type="checkbox" @if( old(1,$subCategory->status)==1  ) checked @endif  value="1" id="status">
