...
@section('title','Sửa danh mục cha')
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('category.update', $category->id)}}">
                        ...
                        <div class="form-group">
                            <label for="nameC_en">Danh mục English <b style="color: red">*</b></label>
                            <input type="text" class="form-control" name="nameC_en" value="{{old('nameC_en',$category->nameC_en)}}"  placeholder="Danh mục English">
                            @error('nameC_en')
                        ...
                        <div class="form-group">
                            <label for="nameV_vie">Danh mục Vietnamese <b style="color: red">*</b></label>
                            <input type="text" class="form-control" name="nameV_vie" id="nameV_vie" value="{{old('nameV_vie',$category->nameV_vie)}}"  placeholder="Danh mục Vietnamese">
                            @error('nameV_vie')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-check">
                            <input style="width: 18px; height: 18px" class="form-check-input " name="status" type="checkbox" @if(old('status', $category->status)==1) checked @endif value="1" id="status">
